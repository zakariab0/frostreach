...
APP_NAME="marzano"
APP_VERSION="0.1.0-alpha.1720080707"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/getgrit/gritql/releases/download/v0.1.0-alpha.1720080707}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.17.0"},"source":{"app_name":"marzano","name":"gritql","owner":"getgrit","release_type":"github"},"version":"0.1.0-alpha.1720080707"}
EORECEIPT
...
The installer for marzano 0.1.0-alpha.1720080707

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/getgrit/gritql/releases/download/v0.1.0-alpha.1720080707
