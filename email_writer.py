...
def generate_personal_text(gender, full_name, profession, language):
    ...
    prompt = (
        f"Can you write a short and personal description for me in {language}? I am {full_name} and my profession is {profession}."
    )
...
def generate_email_content(company_name, recruiter_full_name, recruiter_email, personal_info, profession, language):
    ...
    prompt = (
        ...
        f"The message should be direct, polite, and mention that I am interested in opportunities in {profession} . "
